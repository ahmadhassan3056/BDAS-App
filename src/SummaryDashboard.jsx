...
function Card({ title, subtitle, children, className = "" }) {
  return (
    <div className={`bg-slate-900/60 border border-slate-700 rounded-2xl p-4 ${className}`.trim()}>
...
function GhostBtn({ children, onClick }) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="px-4 py-2 rounded-lg bg-slate-800/70 hover:bg-slate-800 text-white border border-slate-700"
    >
      {children}
    </button>
  )
    ...
    <div className="space-y-4">
      ...
      <div className="grid md:grid-cols-3 gap-3">
        ...
        <button
          ...
          className="text-left bg-slate-900/60 border border-slate-700 rounded-2xl p-4 hover:bg-slate-900/80 transition"
        ...
        >
          ...
          <div className="text-3xl font-extrabold text-emerald-300 mt-1">{basics.enginesOnShortSamplingCount}</div>
          <div className="text-xs text-slate-500 mt-1">
      ...
      {showEngineTailPanel ? (
        <div ref={engineTailRef} className="bg-slate-900/50 border border-slate-700 rounded-2xl p-4">
          ...
          <div className="mt-3 grid sm:grid-cols-2 lg:grid-cols-3 gap-2">
            {(moreEnginesDefects ? basics.latestByEngineArr : basics.latestByEngineArr.slice(0, INITIAL_MED)).map((r) => (
              <button
                ...
                className="text-left px-3 py-2 rounded-xl bg-slate-800/60 border border-slate-700 hover:bg-slate-800 transition"
              >
      ...
      {showShortSamplingPanel ? (
        <div ref={shortSamplingRef} className="bg-slate-900/60 border border-slate-700 rounded-2xl p-4 mt-3">
            ...
            <div>
              <div className="grid sm:grid-cols-2 gap-2 mt-3">
                ...
                <button
                  ...
                  className="text-left p-3 rounded-2xl bg-slate-800/50 border border-slate-700 hover:bg-slate-800 transition"
                >
                    ...
                    {x.items.map((it) => (
                      <div key={it.key} className="text-xs text-slate-300">
                        <div className="flex items-center justify-between gap-2">
                          ...
                          <span className="text-emerald-300 whitespace-nowrap">{it.freq ? `${it.freq} hrs` : "—"}</span>
                        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div>
                ...
                <select
                  value={enginePick}
                  disabled
                  className="w-full mt-1 px-3 py-2 rounded-lg bg-slate-900/60 border border-slate-700 text-slate-100 outline-none focus:ring-2 focus:ring-emerald-500"
                >
              ...
              <div className="space-y-2">
                ...
                return (
                  <button
                    ...
                    className="w-full text-left p-3 rounded-2xl bg-slate-800/50 border border-slate-700 hover:bg-slate-800 transition"
                  >
            ...
            {scopedCounts.defectType.length ? (
              scopedCounts.defectType.map((x) => (
                <button
                  ...
                  className="px-3 py-2 rounded-xl bg-slate-800/70 border border-slate-700 hover:bg-slate-800 text-slate-100"
            ...
            <div className="space-y-2">
              {(moreRecentDefects ? scopedRecentDefects : scopedRecentDefects.slice(0, INITIAL_MED)).map((r) => (
                <button
                  ...
                  className="w-full text-left bg-slate-800/50 border border-slate-700 rounded-xl px-3 py-2 hover:bg-slate-800 transition"
                >
