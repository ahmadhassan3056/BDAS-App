  ...
  return (
    <div className="flex items-start justify-between gap-4">
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          <div className="text-4xl md:text-5xl font-bold tracking-wider text-brand-primary">
            BDAS
          </div>
  ...
  return (
    <div className="relative min-h-[calc(100vh-120px)]">
        ...
        <div className="grid gap-4 w-full max-w-xl">
          <button
            ...
            className="w-full text-left rounded-2xl px-6 py-5 transition shadow-lg
              bg-gradient-to-br from-slate-800/80 to-slate-900/60 border border-brand-border hover:border-emerald-500/50"
          >
          ...
          <button
            onClick={onGoView}
            className="w-full text-left rounded-2xl px-6 py-5 transition shadow-lg
              bg-gradient-to-br from-slate-800/80 to-slate-900/60 border border-brand-border hover:border-amber-500/50"
          >
          ...
          <button
            onClick={onGoSummary}
            className="w-full text-left rounded-2xl px-6 py-5 transition shadow-lg
              bg-gradient-to-br from-slate-800/80 to-slate-900/60 border border-brand-border hover:border-sky-400/50"
          >
      ...
      <div className="absolute bottom-3 left-3 flex flex-col gap-2">
        <button
          onClick={onOpenLogin}
          className="bg-slate-800/70 hover:bg-slate-800 text-white px-4 py-2 rounded-lg border border-brand-border"
          title="Admin Login"
        >
          Admin Login
        </button>
      ...
      <button
        ...
        className="absolute bottom-3 right-3 bg-slate-800/70 hover:bg-slate-800 text-white px-4 py-2 rounded-lg border border-brand-border"
        title="About"
      >
        About
      </button>
    ...
    <div className="space-y-4">
          ...
          <div className="mt-3 border-t border-brand-border/60 pt-3">
            ...
            <div className="max-h-40 overflow-auto space-y-1 pr-1">
              {tails.length === 0 ? (
                ...
                tails.map((t) => (
                  <div key={t.tailNo} className="flex items-center justify-between gap-2 bg-slate-900/40 border border-brand-border/60 rounded-xl px-3 py-2">
          ...
          <div className="mt-3 border-t border-brand-border/60 pt-3">
            ...
            <div className="max-h-40 overflow-auto space-y-1 pr-1">
              {engines.length === 0 ? (
                ...
                engines.map((x) => (
                  <div key={x.engineSN} className="flex items-center justify-between gap-2 bg-slate-900/40 border border-brand-border/60 rounded-xl px-3 py-2">
                ...
                activeAssignments.map((a) => (
                  <tr key={a.id} className="border-t border-slate-800 hover:bg-slate-800/40">
                    ...
                    <td className="px-3 py-2">{a.engineSN}</td>
                      ...
                      {a.detachedAt ? (
                        <span className="px-2 py-1 rounded-full bg-slate-800 border border-brand-border text-xs text-slate-200">
                          Detached
                        </span>
                      ) : (
                        <span className="px-2 py-1 rounded-full bg-brand-secondary/20 border border-emerald-500/40 text-xs text-emerald-200" title={a.engineSN || ""}>
                          Active
                        </span>
                      )}
                    </td>
      ...
      <div className="cardX">
        ...
        <div className="mt-3 grid md:grid-cols-3 gap-3">
          <div className="rounded-2xl border border-brand-border bg-slate-900/40 p-3">
...
function ModalShell({ title, children, onClose }) {
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
      <div className="w-full max-w-md rounded-2xl p-4 border border-brand-border shadow-xl bg-gradient-to-b from-slate-900 to-slate-950">
  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4" onClick={onClose}>
      <div className="max-w-5xl w-full" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="bg-brand-bg border border-brand-border rounded-2xl p-3">
...
function Thumb({ filePath, ensureThumb, onClick }) {
  ...
  return src ? (
    <button
      onClick={onClick}
      className="w-10 h-10 rounded-lg border border-brand-border overflow-hidden hover:ring-2 hover:ring-emerald-500"
      title="Open image"
    >
    ...
    <div className="w-10 h-10 rounded-lg border border-brand-border bg-slate-800/60" />
  )
}
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col md:flex-row gap-3 md:items-end md:justify-between">
        <div>
          <div className="text-xl font-bold text-brand-primary">Borescope Inspection Records</div>
        </div>
        ...
        <div className="flex gap-2">
          <div className="relative">
            ...
            {colPickerOpen ? (
              <div className="absolute right-0 mt-2 w-[300px] bg-slate-900 border border-brand-border rounded-2xl shadow-xl p-3 z-30">
                  ...
                  return (
                    ...
                    >
                      ...
                      {showCol("tstTaf") ? (
                        <td className="px-3 py-2">
                          {r.tstTafEnabled ? (
                            <span className="px-2 py-1 rounded-full bg-brand-secondary/20 border border-emerald-500/40 text-xs text-emerald-200" title={r.tstTafNumber || ""}>
                              ...
                              {docs.slice(0, 3).map((p, i) => {
                                ...
                                return (
                                  <button
                                    ...
                                    className="inline-flex items-center gap-2 px-2 py-1 rounded-lg bg-slate-800 border border-brand-border hover:border-sky-400 text-xs"
                                    title={name}
                                  >
                                    <span className="opacity-80">📎</span>
                                    <span className="max-w-[220px] truncate">{name}</span>
                                    {badge ? (
                                      <span className="ml-1 px-1.5 py-0.5 rounded-md bg-brand-card/60 border border-brand-border text-[10px] tracking-wide">
                                        {badge}
                                      </span>
                                    ) : null}
                                  </button>
            ...
            {isAdmin ? (
              ...
              <div className="rounded-2xl border border-slate-800 bg-slate-900/40 p-6">
                ...
                <div className="mt-4 flex gap-2">
                  ...
                  <button className="px-4 py-2 rounded border border-brand-border hover:bg-slate-800" onClick={() => setTab("home")}>
                    Back to Home
                  </button>
                </div>
              </div>
  ...
  return (
    <div className="cardX">
      ...
      {importHint && importHint.length ? (
        <div className="mt-4 border border-brand-border rounded-xl p-3 bg-slate-900/50">
...
function tabBtn(active) {
  return `px-4 py-2 rounded-lg border transition ${
    active
      ? "bg-brand-secondary text-black border-emerald-400"
      : "bg-slate-800/60 text-white border-brand-border hover:bg-slate-800 hover:border-sky-400/50"
  }`
}
